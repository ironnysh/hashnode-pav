...
![A human’s hand reaching out to a robot with a screenshot of code in the background and flying GitHub Copilot logos hovering in between](https://cdn.hashnode.com/res/hashnode/image/upload/v1661352209189/KbyDKR94z.jpeg align="left")

*Let me Copilot that for you (Background by Fahrul Razi @Unsplash | Hands by Tara Winstead @Pexels)*
...
2. Increase the demand for thoroughly diligent QA people, affirming Dave Rupert’s summary of his experience on the [ShopTalk Show](https://shoptalkshow.com/523/#t=23:07) podcast: “ ***I went from writing code to reading code, and now I’m code-reviewing this robot***.”
...
![A screenshot showing code snippets and suggestions made by GitHub Copilot](https://cdn-images-1.medium.com/max/1024/1*AjcmW0X4YbcPtlgVVcRdpQ.png align="left")

*When prompted, Copilot suggests up to ten code snippets (screenshot)*
...
![XKCD comics about the risks of public datasets: “When you train predictive models on input from your users, it can leak information in unexpected ways”](https://cdn-images-1.medium.com/max/546/0*NkzC0UF9yAAaK1xv align="left")
...
[GitHub Copilot will (not) take your job](https://insights.project-a.com/github-copilot-will-not-take-your-job) was originally published on [Project A Insights](https://insights.project-a.com).